        ...
        <table>
            <tr>
                ...
                <td><input type="text" placeholder="naam" id="naam" onkeyup="foutmelding('naam')">
                    <input type="text" placeholder="tussenvoegsel" id="tussenvoegsel" onkeyup="foutmelding('tussenvoegsel')">
            ...
            <tr>
                ...
                <td><input type="text" placeholder="postcode" id="postcode" onkeyup="foutmelding('postcode')">
                    <input type="text" placeholder="woonplaats" id="woonplaats" onkeyup="foutmelding('woonplaats')">
                </td>
                <td id="postcode-error" id="woonplaats-error"></td>
            </tr>
            <tr>
                <td> telefoon:</td>
            ...
            <tr>
                <td> mobiel:</td>
                <td><input type="number" placeholder="mobiel" id="mobiel" onkeyup="foutmelding('mobiel')"></td>
                <td id="mobiel-error"></td>
